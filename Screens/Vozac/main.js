...
export default function main({route, navigation}) {
  ...
  const ucitajVozacZaduzena = async () => {
    ...
    await fetch(`http://${getIP()}/publictransportcloud/api/Vozac/zaduzeno-vozilo.php?id=${korisnik.id}`)
    .then(response => response.json())
    .then(data => {  
  ...
  const ucitajVozacLinija = async () => {
    ...
    await fetch(`http://${getIP()}/publictransportcloud/api/Vozac/aktivna-linija.php?id=${korisnik.id}`)
    .then(response => response.json())
    .then(data => {  
        setLinija(true)
      }) 
  ...
  const razduziVozilo = () => {
    ...
    fetch(`http://${getIP()}/publictransportcloud/api/VozacVozilo/zavrsi-liniju.php`, {
    method: 'POST', 
    headers: {
        'Content-Type': 'application/json',
    },
