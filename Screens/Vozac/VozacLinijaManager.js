...
export default class VozacLinijaManager extends Component {
  ...
  ucitajRelacije = async () => {
    ...
    await fetch(`http://${getIP()}/publictransportcloud/api/Relacija/read.php?id=${this.state.data.prevoznik_id}`)
  ...
  ucitajVozacLinija = async () => {
    ...
    await fetch(`http://${getIP()}/publictransportcloud/api/Vozac/aktivna-linija.php?id=${this.state.data.id}`)
    .then(response => response.json())
    .then(data => {  
  ...
  ucitajStaniceRelacije = async () => {
    ...
    await fetch(`http://${getIP()}/publictransportcloud/api/RelacijaStanica/readNiz.php?id=${this.state.relacija_id}`)
    .then(response => response.json())
    .then(data => {  
  ...
  updateSljedecuStanicu = async () => {
    ...
    fetch(`http://${getIP()}/publictransportcloud/api/Linija/sljedeca-stanica.php`, {
    method: 'POST', 
    headers: {
